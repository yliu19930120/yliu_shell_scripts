...
javaProjects=('yliu_base_server' 'yliu_crawler' 'yliu_crawler_core' 'yliu_executer' 'yliu_utils_mongo' 'yliu_scheduler' 'yliu_utils_redis' 'yliu_base_core' 'yliu_scheduler_server' 'yliu_data_akshare')
